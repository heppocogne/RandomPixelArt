...
func _on_LineEdit_text_changed(new_text:String):
	if has_theme_icon(new_text,"EditorIcons"):
...
func set_error(msg:String):
	error_message.add_theme_color_override("font_color",error_color)
	error_message.text=msg


func set_success(msg:String):
	error_message.add_theme_color_override("font_color",success_color)
	error_message.text=msg
